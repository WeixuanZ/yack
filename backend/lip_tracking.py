...
class FaceDetector:
    ...
    def find_speaker_face(self, frame):
        ...
        speaker_face = Rect(((frame.shape[0] // 2) - 10)*scaling_ratio, 
        ...
        for rect in rects:
            ...
            if (mouth_open / mouth_width) > speaker_mouth_ratio:
                ...
                speaker_face = Rect(x*scaling_ratio, y*scaling_ratio, 
                                    w*scaling_ratio, h*scaling_ratio)
        ...
        speakers_bb = Rect(min_x*scaling_ratio, 
                            min_y*scaling_ratio,
